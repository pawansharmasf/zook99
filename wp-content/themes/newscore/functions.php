...
if ( class_exists( 'Radium_Framework' ) ) : //check if the Radium Framework class exists
    ...
    class Radium_Theme_Framework extends Radium_Framework {
        ...
        public function includes() {
            ...
            if(function_exists('bp_is_active') OR function_exists('is_bbpress')) { require_once($this->theme_includes_dir . '/extensions/buddypress-functions.php'); }
...
function excerptinvideo( $atts ){
    return '<div class="videoFrame">'. get_the_excerpt() . '</div><!-- .videoFrame -->';
}
add_shortcode( 'video_code', 'excerptinvideo' );
