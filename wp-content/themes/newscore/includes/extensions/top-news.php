...
if( ! function_exists('radium_top_news') ) {
	...
	function radium_top_news() {
	    ...
	    $display_type 		= radium_get_option('menu_top_news_display_type', false, 'today');
	    $max_number_posts 	= radium_get_option('menu_top_news_number_posts', false, 12);
	    $max_count 			= radium_get_option('menu_top_news_max_post_count', false, 100); //too high may cause performance issues
