...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
					    ...
					    'sub_desc' => __('You can place a banner ad code. This will override the the two wettings above', 'radium'),
					    ),
				...
				'desc' => __(' ', 'radium'),
 				...
 				'fields' => array(
					...
					array(
					    ...
					    'type' => 'text',
					    'title' => __('All Post Page Title', 'radium'),
    		...
    		$sections[] = array(
                ...
                'fields' => array(
                        ...
                        array(
                            'id' => 'youtube_username',
                            'type' => 'text',
                            'title' => __('YouTube', 'radium'),
                            'sub_desc' => __("Your YouTube username", 'radium'),
                            'desc' => '',
                            'std' => ''
                            ),
