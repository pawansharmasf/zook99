...
if ( !function_exists('radium_site_header_toolbar_tools') ) {
    ...
    <div class="header-tools">
        ...
        <ul class="menu right">
            ...
            <?php } ?>
            <?php if ( $framework->is_plugin_active ('yith-woocommerce-wishlist/init.php')  && $whishlist ) { ?>
...
function radium_site_header_random_article(){
    ...
    ?>
        <div id="header-random" class="bg-icon-random-white">
            <a href="<?php echo home_url(); ?>/?rmrand" class="random-article icon-shuffle ttip" title="<?php echo $header_random_title; ?>"></a>
        </div><!-- .header-random -->
...
if ( !function_exists('radium_author_icons') ) {
	...
	<ul class="author-links">
		...
		if (get_the_author_meta('user_url')) { ?>
			...
			<li><a target="_blank" href="<?php the_author_meta('user_url'); ?>" ><span class="social-icon www <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('twitter')) { ?>

			<li><a target="_blank" href="http://www.twitter.com/<?php the_author_meta('twitter'); ?>" class="" title="<?php the_author_meta('display_name'); ?> on Twitter"><span class="social-icon twitter <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('facebook')) { ?>

			<li><a target="_blank" href="<?php the_author_meta('facebook'); ?>" title="<?php the_author_meta('display_name'); ?> on Facebook"><span class="social-icon facebook <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('dribbble')) { ?>

			<li><a target="_blank" href="<?php the_author_meta('dribbble'); ?>" title="<?php the_author_meta('display_name'); ?> on Dribbble"><span class="social-icon dribble <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('instagram')) { ?>

			<li><a target="_blank" href="<?php the_author_meta('instagram'); ?>" title="<?php the_author_meta('display_name'); ?> on Instagram"><span class="social-icon instagram <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('google_plus')) { ?>

			<li><a target="_blank" href="<?php the_author_meta('google_plus'); ?>" title="<?php the_author_meta('display_name'); ?> on Google+"><span class="social-icon googleplus <?php echo $style; ?>"></span></a></li>

		<?php } if (get_the_author_meta('email')) { ?>

			<li><a target="_blank" href="mailto:<?php the_author_meta('email'); ?>" title="Email <?php the_author_meta('display_name'); ?>"><span class="social-icon email <?php echo $style; ?>"></span></a></li>
