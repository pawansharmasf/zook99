...
class Radium_Social_Fans_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        $facebook_followers = $facebook ? intval(radium_get_facebook_likes( radium_get_option('facebook_page_url'))) : 0;
        ...
        $youtube_subscribers = $youtube ? intval(radium_get_total_youtube_subscribers(radium_get_option('youtube_username'))) : 0;
        $vimeo_followers 	= $vimeo ? intval(radium_get_total_vimeo_followers(radium_get_option('vimeo_username'))) : 0;
        $dribbble_followers = $dribbble ? intval(radium_get_total_dribbble_followers(radium_get_option('dribbble_username'))) : 0;
        ...
        /* Display the widget title if one was input (before and after defined by themes). */
            ...
            <div class="fans-home clearfix">
				...
				<?php } ?>
				<?php if ( radium_get_option('youtube_username') && $youtube == 'on') { ?>
				    <div class="fans-youtube"><a href="<?php echo radium_get_total_youtube_subscribers(radium_get_option('youtube_username'), 'link'); ?>" target="_blank"><span class="social-icon youtube"></span><p data-text="<?php echo $youtube_subscribers; ?>"><span><?php echo $youtube_subscribers; ?></span></p></a></div>
				<?php } ?>
